...
QTrackingPlot2D::QTrackingPlot2D( cptrParticlesContainer particles_, QString _title, QWidget *parent )
    : QBoxPainter { parent }, particles { particles_ }, title { std::move(_title) }
{   
